...
export const GEAR_STATS = {
    ...
    "Ritualist's": {
        Helm: { Vitality: 54, 'Healing Power': 30, 'Condition Damage': 54, Expertise: 30 },
        Shoulders: { Vitality: 40, 'Healing Power': 22, 'Condition Damage': 40, Expertise: 22 },
        Chest: { Vitality: 121, 'Healing Power': 67, 'Condition Damage': 121, Expertise: 67 },
        Gloves: { Vitality: 40, 'Healing Power': 22, 'Condition Damage': 40, Expertise: 22 },
        Leggins: { Vitality: 81, 'Healing Power': 44, 'Condition Damage': 81, Expertise: 44 },
        Boots: { Vitality: 40, 'Healing Power': 22, 'Condition Damage': 40, Expertise: 22 },
        Amulet: { Vitality: 133, 'Healing Power': 71, 'Condition Damage': 133, Expertise: 71 },
        Ring1: { Vitality: 106, 'Healing Power': 56, 'Condition Damage': 106, Expertise: 56 },
        Ring2: { Vitality: 106, 'Healing Power': 56, 'Condition Damage': 106, Expertise: 56 },
        Accessory1: { Vitality: 92, 'Healing Power': 49, 'Condition Damage': 92, Expertise: 49 },
        Accessory2: { Vitality: 92, 'Healing Power': 49, 'Condition Damage': 92, Expertise: 49 },
        Back: { Vitality: 52, 'Healing Power': 27, 'Condition Damage': 52, Expertise: 27 },
        Weapon1: { Vitality: 108, 'Healing Power': 59, 'Condition Damage': 108, Expertise: 59 },
        Weapon2: { Vitality: 108, 'Healing Power': 59, 'Condition Damage': 108, Expertise: 59 },
    },
};
